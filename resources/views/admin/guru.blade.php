    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Buat Guru Baru</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="form-validation">
                    <form id="create-user" action="{{ route('admin.guru.store') }}" name="create-user" method="POST" enctype="multipart/form-data">
                    @csrf
...
<div id="modal-edit-{{ $d->ID_USER }}" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Guru #{{ $d->ID_USER }}</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form-valide" action="{{ route('admin.guru.update',$d->ID_USER) }}" name="edit-user" method="POST" enctype="multipart/form-data" id="form-edit-{{ $d->ID_USER }}">
                @method('PUT')
                @csrf
                    <div class="form-group">
                        <label>Tipe User</label>
...
<div class="modal fade" id="modal-delete-{{ $d->ID_USER }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete Guru #{{ $d->ID_USER }}</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.guru.destroy',[$d->ID_USER]) }}" method="POST">
                    @method('DELETE')
                    @csrf
                    Apakah anda yakin ingin menghapus guru {{ $d->NAMA_LENGKAP }} ?
                    <div class="modal-footer">
